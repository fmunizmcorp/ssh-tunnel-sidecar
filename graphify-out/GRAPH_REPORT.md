...
Cohesion: 0.40
Nodes (5): 7. ESTRUTURA DO REPO, Arquivos da raiz (amostra), Diretorios principais, code:block4 (.claude), code:block5 (.gitignore)
...
Cohesion: 0.29
Nodes (7): 1. Criar novo projeto no EasyPanel, 2. Configurar variveis de ambiente, 3. Configurar networking, 4. Configurar o uscall-scraper, Como Usar no EasyPanel, code:bash (SSH_HOST=192.168.192.164), code:bash (# REMOVER ESTAS (no funciona em rede bridge):)

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (15): 10. CHECKLIST DE ENTREGA OBRIGATORIO, 11. REFERENCIAS RAPIDAS, 9. APRENDIZADO E ATUALIZACAO CONTINUA, Arquitetura, Codigo, Deploy, Documentacao, Problema que Resolve (+7 more)
